...
-->
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															...
															<span class="admin-name">Lab technician</span>
															<i class="icon nalika-down-arrow nalika-angle-dw"></i>
														</a>
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        <li><a href="index.php"><span class="icon nalika-home author-log-ic"></span> Home</a>
                                                        </li>
                ...
                <div class="col-md-12">
                    <div class="row">
						...
						<div style="width: 100%; height: 10%; margin-top: 10%; position:absolute; vertical-align: middle; text-align: center;">
									     ...
									     <a href="view2.php" class="btn-begin-test">View Patient Data</a>
