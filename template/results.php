        ...
        <nav id="sidebar" class="">
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
					...
					<h2>PHYSICIAN<span class="min-dtn"></span></h2>
				</div>
   ...
   <!-- Start Welcome area -->
    <div class="all-content-wrapper">
     ...
     <div class="section-admin container-fluid">
      ...
      <h1 class="mt-5">This Patient is:
      <b style = "color:#8721b2" size=200%>{{res}} </b> <br> with <b style = "color:green" size=200%>{{resx}}% </b> chance of having diabetes</h1>
    </main>
					
					<a class="btn btn-info btn-lg pull-right" href="{{ url_for('viewtests2') }}" role="button">Back to Test</a>
                    <a class="btn btn-success btn-lg pull-left" href="{{ url_for('viewrecords') }}" role="button">Back to Patients</a>
