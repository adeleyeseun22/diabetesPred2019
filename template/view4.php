...
---->
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Google Map" href="#"><span class="mini-sub-pro">Start Diagnosis</span></a></li>
								<li><a title="Google Map" href="#"><span class="mini-sub-pro">Add Patient Record</span></a></li>
								<li><a title="Google Map" href="#"><span class="mini-sub-pro">View Patient Data</span></a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="File Manager" href="#"><span class="mini-sub-pro">File Manager</span></a></li>
                                <li><a title="Blog" href="#"><span class="mini-sub-pro">View Similar Diseases</span></a></li>
	 ...
	 <div class="section-admin container-fluid">
		...
		<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    ...
				                    <form role="form" action="#" method="post" class="diagnosis-form">
										

                                        <!--
										<div class="form-group">
				                    		<label class="sr-only" for="Name">First Name</label>
				                        	<input type="text" name="firstname" placeholder="Patient FirstName" class="name form-control" id="firstname">
				                        </div>
										
										
										<div class="form-group">
				                    		<label class="sr-only" for="Name">Last name</label>
				                        	<input type="text" name="lastname" placeholder="Patient Lastname" class="name form-control" id="name">
				                        </div>
                                                        ...
                                                        while ( $rows = $resultset->fetch_assoc()) 
                                                        {
                                                           ...
                                                           // $output .= "FirstName: $PatientFname<br /> Lastname: $PatientLname<br /><br />";
                                                             echo "<tr bgcolor=white>";
                                                                ...
                                                                echo "<td> <a href ='select2.php?id=$id'>view</a> </td>";

                                                                '<td><button id="ViewtestBtn" class="btn btn-primary" name=ViewtestBtn method="POST" formaction=#>View Test</button>
                                                                 </td>'.
                                                             "</tr>";
                                                                                                        }
                                                    }else
                                       ...
                                       <!--View Test of a particular patient-->
                                            ...
                                            <form action="search2.php" method="POST">
                                                <form role="search" class="">
                                                <input type="text" name="search" placeholder="Search for Records..." class="form-control" />
                                               <!-- <a href=""><i class="fa fa-search"></i></a>-->
                                            ...
                                            <!--
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-outline-success btn-sm btn-block pull-left" style="width: 200px; " name="AddRecord">Add Record</button>
                                                </div>
                                            -->
                                                <!--
                                                <div class="form-group">
                                                <button type="submit" href="patientData.php" class="btn btn-outline-success btn-sm btn-block pull-right" style="width: 200px; " name="AddRecord"><a href="patientData.php" style="color:inherit"> Button text with correct colors </a>View Records</button>
                                                </div>
                                          -->
                                          <button type="button" class="btn btn-outline-success and-all-other-classes"> 
                                          <a href="patientData.php" style="color:inherit"> Add Patient</a>
                                        </button>


                                        <button type="button" class="btn btn-outline-success and-all-other-classes"> 
                                          <a href="view3.php" style="color:inherit"> View All Records</a>
                                        </button>

                                        <button type="button" class="btn btn-outline-success and-all-other-classes"> 
                                          <a href="hi.py" style="color:inherit">Hello World</a>
                                        </button>
                        ...
                        <div style="width: 100%; height: 10%; margin-top: 10%; position:absolute; vertical-align: middle; text-align: center;">
                            
                                         <a href="patientData.php" class="add-record">Start Diagnosis</a>
...
-->
				                        ...
				                        <button type="submit" class="btn" name="submit">View Records!!</button>
				                    </form>
			                    </div>
		-->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright © 2018 <a href="https://colorlib.com/wp/templates/">GlucoDS</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
