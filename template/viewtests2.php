...
<div class="table-responsive" style="width: 108%;">
    <a class="btn btn-primary pull-left" href="{{ url_for('viewrecords') }}" role="button">Back</a></h2>
    <a class="btn btn-warning pull-right" href="{{ url_for('classification') }}" role="button">Classification</a></h2>
    <h2 style="text-align: center; color: medium black; font: Times New Roman;">Test List <!-- <button type="button" class="btn btn-success pull-right pull-right" data-toggle="modal" data-target="#mymodal">Add Test</button> --></h2>
                ...
                <form action="{{ url_for('predict') }}" method="POST">
                   <div class="form-group" id="updateForm">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                    <button type="submit" class="btn btn-success" name="submit" id="update_data">Predict</button>
