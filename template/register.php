...
<html lang="en">
    ...
    <head>
        ...
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="ico/apple-touch-icon-114-precomposed.png">
                        ...
                        <div class="col-sm-5">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="connect.php" method="post" class="registration-form">
										...
										<div class="form-group">
				                        	...
				                        	<input type="number" name="number" placeholder="Mobile No..." class="form-number form-control" id="form-number">
				                        </div>
