        ...
        <nav id="sidebar" class="">
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
					...
					<h2> <span class="min-dtn">LAB TECHNICIAN</span></h2>
				</div>
...
{% block body %}
<div class="container" class="with=auto;">
<div class="table-responsive">
    <h2>Test List <button type="button" class="btn btn-success pull-right pull-right" data-toggle="modal" data-target="#mymodal">Add Test</button></h2>
...
<tr bgcolor="white">
    ...
    <td>
        ...
        <a href="/update/{{data.P_ID}}" class="btn btn-warning btn-xs" data-toggle="modal" data-test="{{data.Test_ID}}" data-lab="{{data.Lab_ID}}" data-physician="{{data.Physician_ID}}" data-patient="{{data.Patient_ID}}" data-age="{{data.Age}}" data-bmi="{{data.BMI}}" data-FastingGlucose="{{data.FastingGlucose}}" data-TwoHrsGlucose="{{data.TwoHrsGlucose}}" data-RandomGlucose="{{data.RandomGlucose}}" data-InsulinFasting="{{data.InsulinFasting}}" data-InsulingTwoHrs="{{data.InsulingTwoHrs}}"data-InsulinRandom="{{data.InsulinRandom}}"data-BloodPressure="{{data.BloodPressure}}"data-DPF="{{data.DPF}}" data-toggle="modal"  data-id='{{data.P_ID}}' 
        ...
        <a href="" class="btn btn-primary btn-xs">Predict</a>
    </td>
</tr>
            ...
            <div class="modal-body">
                ...
                <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="id" value="data.P_ID">
                                        ...
                                        <select id="lab" name="doctor" class="form-control">
                            ...
                            <input type="hidden" name="id" value="data.P_ID">
                                        ...
                                        <label>Patient</label>
                                        <select id="patient" name="doctor" class="form-control">
                                           <option value="" disabled selected>Select Patient</option>
                                            {% for account3 in account3 %}
                                        <option selected value='{{ account.P_ID}}'>{{account.FirstName}}</option>
                                        {% endfor %}
                                        </select>
                                   </div>
                        ...
                        <label>Age:</label>
                        <input type="text" class="form-control" name="FirstName" value= "{{data.Age}}" required="1" id="age">
                    ...
                    <div class="form-group">
                        ...
                        <label>BMI:</label>
                        <input type="text" class="form-control" name="FirstName" value= "{{data.Bmi}}" required="1" id="bmi">
...
<div id="mymodal" class="modal fade" role="dialog">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                 <form action="{{ url_for('viewtests') }}" method="POST" id="submit_form"> 
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="bmi" required="1" min="8" max="100">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="fastingglucose" required="1" min="30" max="135">
                    </div>

                    <div class="form-group">
                        <label>2Hours Glucose:</label>
                        <input type="number" class="form-control" name="TwoHoursGlucose" required="1" min="50" max="140">

                    </div>

                    <div class="form-group">
                        <label>Random Glucose:</label>
                        <input type="number" class="form-control" name="RandomGlucose" required="1" min="50" max="250">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="Insulinfasting" required="1" min="75" max="130">

                    </div>


                     <div class="form-group">
                        <label>Insulin 2Hours:</label>
                        <input type="number" class="form-control" name="Insulin2Hours" required="1" min="130" max="180">

                    </div>

                    <div class="form-group">
                        <label>Insulin Random:</label>
                        <input type="number" class="form-control" name="InsulinRandom" required="1" min="90" max="200">

                    </div>

                    <div class="form-group">
                        <label>Blood Pressure:</label>
                        <input type="number" class="form-control" name="BloodPressure" required="1" min="90" max="190">

                    </div>

                    <div class="form-group">
                        <label>Diabetes Pedigree Function:</label>
                        <input type="number" class="form-control" step=0.0001 name="PedFunction" required="1">
