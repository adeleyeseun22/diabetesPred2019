...
-->
	 ...
	 <div class="section-admin container-fluid">
            <div class="row admin text-center">
                ...
                $sql = "SELECT P_ID, test.Age, test.Bmi, test.FastingGlucose, test.2HrsGlucose, test.RandomGlucose, test.Insulinfasting, test.Insulin2Hrs, test.InsulinRandom, test.BloodPressure, test.DPF, test.Lab_ID, test.Test_ID, PatientFName, PatientLName from patientdata join test on patientdata.P_id=test.test_id";
...
<?php 
                ...
                '<td><button id="PredictButton" class="btn btn-primary">Predict</button>
                                </td>'.
             "</tr>";
		...
		<div class="form-box">
                        		<div class="form-top">
	                        		<div class="form-top-left">
	                            		<h4>Enter Patient Details to search for record</h4>
	                        		</div>
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="#" method="post" class="diagnosis-form">
				                        ...
				                        <button type="submit" class="btn" name="submit">View Record</button>
				                    </form>
			                    </div>
